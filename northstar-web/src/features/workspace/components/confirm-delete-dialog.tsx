...
import { Disintegrate } from "@/features/theme/disintegrate";
  ...
  return (
    <Dialog open={!!project} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <Disintegrate active={disintegrating} onComplete={handleDisintegrateComplete}>
          <div>
            <DialogHeader>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end">
                <Button
                  ...
                  disabled={!canDelete || deleteMutation.isPending || disintegrating}
                >
                  {disintegrating ? "Disintegrating..." : deleteMutation.isPending ? "Deleting..." : "Delete this project"}
                </Button>
              </div>
            </div>
          </div>
